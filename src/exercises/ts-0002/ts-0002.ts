/*DOM Elements*/
const getMessageToUser = (): any =>
  document.querySelector(".message-to-user-text");
const getForm = (): any => document.querySelector("#form");
const getBrandName = (): any => document.querySelector("#brand-name");
const getButton = (): any => document.querySelector(".button");
const getInfo = (): any => document.querySelector(".icon-hint");
const getResponseSearch = (): any =>
...
/*Submit name*/
getForm().addEventListener("submit", (event: any) => {
